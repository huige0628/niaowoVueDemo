        ...
        <el-tab-pane label="基本信息" name="first">
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="社会信用代码" prop="code">
                <el-input v-model="formData.code" placeholder="请输入社会信用代码" clearable></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="供应商名称" prop="name">
                <el-input v-model="formData.name" placeholder="请输入供应商名称" clearable></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
          ...
          <el-row>
            <el-form-item label="注册地址" prop="address">
              <el-input type="textarea" v-model="formData.address" placeholder="请输入注册地址" clearable></el-input>
            </el-form-item>
          </el-row>
          <el-row>
            <el-col :span="12">
            ...
            <el-col :span="12">
              <el-form-item label="规模类型" prop="scaleType">
                <el-select v-model="formData.scaleType" placeholder="请选择规模类型" style="width: 100%;">
                  <el-option label="生成加工型企业" value="shanghai"></el-option>
                  <el-option label="外贸型企业" value="beijing"></el-option>
                </el-select>
              </el-form-item>
